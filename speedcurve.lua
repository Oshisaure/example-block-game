...
Levels = {
    ...
    {name = "Master", description = "A 30-level mode that starts on infinite gravity, yet keeps going faster",
     LV = "10L", prev = 5, hold = true, colour = {0.35,0.10,0.15,1},
		...
		{level_name = "M11", gravity = math.huge, lock_delay = 0.574, spawn_delay = 0.287, spawn_delay_after_line = 0.287, line_delay = 0.215, AS_delay = 0.150, BGM = 4},
		{level_name = "M12", gravity = math.huge, lock_delay = 0.543, spawn_delay = 0.272, spawn_delay_after_line = 0.272, line_delay = 0.204, AS_delay = 0.150, BGM = 4},
		{level_name = "M13", gravity = math.huge, lock_delay = 0.514, spawn_delay = 0.257, spawn_delay_after_line = 0.257, line_delay = 0.193, AS_delay = 0.150, BGM = 4},
		{level_name = "M14", gravity = math.huge, lock_delay = 0.486, spawn_delay = 0.243, spawn_delay_after_line = 0.243, line_delay = 0.182, AS_delay = 0.150, BGM = 4},
		{level_name = "M15", gravity = math.huge, lock_delay = 0.460, spawn_delay = 0.230, spawn_delay_after_line = 0.230, line_delay = 0.172, AS_delay = 0.150, BGM = 4},

		{level_name = "M16", gravity = math.huge, lock_delay = 0.435, spawn_delay = 0.217, spawn_delay_after_line = 0.217, line_delay = 0.163, AS_delay = 0.150, BGM = 4},
		{level_name = "M17", gravity = math.huge, lock_delay = 0.411, spawn_delay = 0.206, spawn_delay_after_line = 0.206, line_delay = 0.154, AS_delay = 0.150, BGM = 4},
		{level_name = "M18", gravity = math.huge, lock_delay = 0.389, spawn_delay = 0.195, spawn_delay_after_line = 0.195, line_delay = 0.146, AS_delay = 0.146, BGM = 4},
		{level_name = "M19", gravity = math.huge, lock_delay = 0.368, spawn_delay = 0.184, spawn_delay_after_line = 0.184, line_delay = 0.138, AS_delay = 0.138, BGM = 4},
		{level_name = "M20", gravity = math.huge, lock_delay = 0.348, spawn_delay = 0.174, spawn_delay_after_line = 0.174, line_delay = 0.131, AS_delay = 0.131, BGM = 4},

		{level_name = "M21", gravity = math.huge, lock_delay = 0.330, spawn_delay = 0.165, spawn_delay_after_line = 0.165, line_delay = 0.124, AS_delay = 0.124, BGM = 4},
		{level_name = "M22", gravity = math.huge, lock_delay = 0.312, spawn_delay = 0.156, spawn_delay_after_line = 0.156, line_delay = 0.117, AS_delay = 0.117, BGM = 4},
		{level_name = "M23", gravity = math.huge, lock_delay = 0.295, spawn_delay = 0.147, spawn_delay_after_line = 0.147, line_delay = 0.111, AS_delay = 0.111, BGM = 4},
		{level_name = "M24", gravity = math.huge, lock_delay = 0.279, spawn_delay = 0.140, spawn_delay_after_line = 0.140, line_delay = 0.105, AS_delay = 0.105, BGM = 4},
		{level_name = "M25", gravity = math.huge, lock_delay = 0.264, spawn_delay = 0.132, spawn_delay_after_line = 0.132, line_delay = 0.099, AS_delay = 0.099, BGM = 4},

		{level_name = "M26", gravity = math.huge, lock_delay = 0.250, spawn_delay = 0.125, spawn_delay_after_line = 0.125, line_delay = 0.094, AS_delay = 0.094, BGM = 4},
		{level_name = "M27", gravity = math.huge, lock_delay = 0.236, spawn_delay = 0.118, spawn_delay_after_line = 0.118, line_delay = 0.089, AS_delay = 0.089, BGM = 4},
		{level_name = "M28", gravity = math.huge, lock_delay = 0.223, spawn_delay = 0.112, spawn_delay_after_line = 0.112, line_delay = 0.084, AS_delay = 0.084, BGM = 4},
		{level_name = "M29", gravity = math.huge, lock_delay = 0.211, spawn_delay = 0.106, spawn_delay_after_line = 0.106, line_delay = 0.079, AS_delay = 0.079, BGM = 4},
		{level_name = "M30", gravity = math.huge, lock_delay = 0.200, spawn_delay = 0.100, spawn_delay_after_line = 0.100, line_delay = 0.075, AS_delay = 0.075, BGM = 4},
    },
