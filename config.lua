...
Bindlist = {
	...
	{"cw1", "Rotate Clockwise #1"},
	{"cw2", "Rotate Clockwise #2"},
	{"cw3", "Rotate Clockwise #3"},
	{"cw4", "Rotate Clockwise #4"},
	{"ccw1", "Rotate Counter-Clockwise #1"},
	{"ccw2", "Rotate Counter-Clockwise #2"},
	{"ccw3", "Rotate Counter-Clockwise #3"},
	{"ccw4", "Rotate Counter-Clockwise #4"},
	{"hold", "Hold"},
	{"pause", "Pause"},
}
